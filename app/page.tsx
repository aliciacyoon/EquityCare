  ...
  return (
    <main className="bg-[#f7f2df] text-slate-900">
      <section className="bg-[#f7f2df] py-16 md:py-20">
        <div className="flex flex-col md:flex-row items-center px-4 gap-4">
          <div className="flex-1 flex flex-col items-center">
            <h1 className="text-[clamp(3rem,10vw,8rem)] font-bold py-6 leading-tight">Equity<span style={{ color:"#f26f07" }}>Care</span></h1>
            <h1 className="text-[clamp(2rem,10vw,6rem)] font-bold py-6 leading-tight">Mobile Health Care</h1>
            <h3 className="text-[clamp(1rem,10vw,2rem)] italic font-bold py-6 leading-tight">Prevention • Education • Access</h3>
            <a
