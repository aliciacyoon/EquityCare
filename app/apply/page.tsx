      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-6 py-16 bg-black/40 space-y-8">
          <div className="space-y-6">
            ...
            <div>
              <p className={`${plusJakartaSans.className} text-xl font-bold max-w-3xl`}>Interested in making a difference?</p>
              <p className={`${plusJakartaSans.className} text-xl font-bold max-w-3xl`}>You're in the right place!</p>
            </div>
            <p className={`${plusJakartaSans.className} text-lg max-w-3xl`}>Must by 15+ years old.</p>
          </div>

          <div className="flex gap-32 mt-6">
            <Link href="https://forms.gle/2ThFqAEhWFUmxiCA7" className="bg-[#f28b1e] hover:bg-[#cf7517] px-8 py-4 rounded-md text-lg font-semibold transition">Become a Volunteer</Link>
