        ...
        <div className="mx-auto max-w-6xl flex gap-12 items-start">
          ...
          <div className="flex-1 pt-4">
            ...
            <p className="text-center text-black text-[1.58rem] leading-[2.57rem] tracking-[-0.04px] font-[family-name:var(--font-body)]">
              At EquityCare, we believe where you come from should never determine the 
                quality of care you receive. We work alongside young adults in Orange County---particularly
                those from underserved and immigrant communities---to break down the barriers between them 
                and the healthcare system. Through accessible, culturally responsive education and resources,
                we help people understand their options, speak up for their needs, and build the foundation
                for lasting physical and mental well-being.
            </p>
          </div>
        </div>
      </section>
       ...
       <section className="bg-[#f7f2df] py-16 px-6">
        <div className="mx-auto max-w-6xl flex gap-12 items-start">
          ...
          <div className="flex-1 pt-4">
            ...
            <p className="text-center text-black text-[1.58rem] leading-[2.57rem] tracking-[-0.04px] font-[family-name:var(--font-body)]">
              EquityCare meets people where they are. Our mobile pop-up clinics come directly
                to the spaces communities already know and trust: churches, campuses, etc. We offer
                basic physical adn mental health screenings in a welcoming, judgement-free environment.
                We walk you through your results together and connect you to local resources that actually fit. 
                Every visit is also a chance to build real health literacy---helping participants
                understand how to find the reight care, navigate insurance, and make sense of their own
                health on their own terms. Every person who walks away from one of our clinics feels not just
                informed, but seen, supported, and ready to take the next step.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="w-full px-8 py-12 flex flex-col items-center gap-12">
        ...
        <div className="flex flex-row justify-center items-start gap-10">
          <div className="flex flex-col items-center gap-3">
            <img className="w-80 h-80 bg-gray-300 rounded-full border border-gray-400 object-cover" src="headshot.png" />
   ...
   **/}
      ...
      <div className = "bg-[#D08A8C] py-14 px-6">
          ...
          <p className="text-white text-center text-[1.23rem] leading-[1.85rem] max-w-xl mx-auto mb-10 font-[family-name:var(--font-body)]">
            EquityCare  is committed to solidifying partnerships to give delegates the means to 
